...
ap = geopandas.read_file('{}/data/FAA-Airports/Airports.dbf'.format(path_to_emcore))
...
lonlats = np.array(getLatLons(points[0], points[1])) # convert meshgrid to a list of lon/lat points.
